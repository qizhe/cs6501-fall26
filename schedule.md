...
| Mon 10/06 | Interconnect III: CXL II | [CXL-virtual](https://www.usenix.org/system/files/osdi24-zhong-yuhong.pdf); [Octopus](https://www.usenix.org/conference/nsdi26/presentation/zhong) |
...
| Mon 10/20 | Host Network I | [Understanding the Host Network](https://www.cs.cornell.edu/~ragarwal/pubs/understanding-the-host-network.pdf); [PingPoint](https://pages.cs.wisc.edu/~mgliu/papers/PingPoint-sigcomm26.pdf) |
...
|---|---|---|
| Wed 11/26 | No class | — |
| Mon 12/01 | System for inference | [vLLM](https://arxiv.org/pdf/2309.06180); [DistServe](https://www.usenix.org/conference/osdi24/presentation/zhong-yinmin) |
...
| Date | Topic | Readings |
|---|---|---|
| Mon 12/08 | No class | **Final Report Deadline**|
